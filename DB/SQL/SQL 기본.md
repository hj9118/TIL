...
| 예약어 | 의미                              |
| :----: | --------------------------------- |
|  ANY   | 결과 중 같은 값이 있다면 반환     |
|  ALL   | 전체 결과와 연산 값이 같아야 반환 |

- `= ANY`는 IN 연산자와 같은 의미로 사용. 단 서브쿼리 결과에만 사용 가능
</details>
...
price가 1500인 값에 1 (true), 아닌 값에 0 (false)이 부여. </br>
